-- Supprimer d'abord les politiques existantes si elles existent
DROP POLICY IF EXISTS "Users can view their own submissions" ON subject_submissions;
DROP POLICY IF EXISTS "Users can insert their own submissions" ON subject_submissions;
DROP POLICY IF EXISTS "Users can update their own submissions" ON subject_submissions;
DROP POLICY IF EXISTS "Admins can view all submissions" ON subject_submissions;
DROP POLICY IF EXISTS "Admins can update all submissions" ON subject_submissions;
...
DROP POLICY IF EXISTS "Admins can view all AI responses" ON ai_responses;

-- Supprimer les triggers existants
DROP TRIGGER IF EXISTS update_subject_submissions_updated_at ON subject_submissions;
